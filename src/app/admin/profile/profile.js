angular.module('snowWhite.admin_profile', [
  'ui.router',
  'restAPIService'
])
    ...
    $stateProvider.state('admin_profile', {
        ...
        views: {
            "main": {
                ...
                templateUrl: 'admin/profile/profile.tpl.html'
            }
        },
...
.controller('adminProfileCtrl', function adminProfileController($window, $rootScope, $scope, $translate, $location, $cookies, $restAPIService, $upload, supplementalApiUri) {
