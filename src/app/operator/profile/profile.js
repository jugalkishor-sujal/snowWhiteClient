angular.module('snowWhite.operator_profile', [
  'ui.router',
  'restAPIService'
])

.config(function config($stateProvider) {
    $stateProvider.state('operator_profile', {
        url: '/operator/profile',
        views: {
            "main": {
                controller: 'operatorProfileCtrl',
                templateUrl: 'operator/profile/profile.tpl.html'
            }
        },
...
.controller('operatorProfileCtrl', function operatorProfileController($window, $rootScope, $scope, $translate, $location, $cookies, $restAPIService,$upload, supplementalApiUri) {
